...
function CheckboxGroup(props: Props) {
    ...
    function renderRadio(title: string, value: string) {
        return (
            <label className='flex flex-nowrap items-center gap-4 rounded-[4px] overflow-hidden border border-slate-500 h-[48px] pl-[18.25px] cursor-pointer has-[:checked]:bg-[rgba(216,219,47,.15)] has-[:checked]:border-lime transition-colors duration-150 ease-out'>
